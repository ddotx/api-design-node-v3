...
//*==> Controllers implement the logic --> DB models
//*==> REST Approach require CRUD actions on resource
...
const run = async () =>{
    ...
    const item = await Item.create({
        name: 'Clean up',
        createdBy: mongoose.Types.ObjectId(), //!create fake
        list: mongoose.Types.ObjectId() //!create fake
    })
